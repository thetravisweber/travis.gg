<template>
  <div class="petistawork">
    <WorkTitle>Petista</WorkTitle>
    <div class="work-description">
      <p>
        For the last two years, I have been working for a company called <a href="https://petista.com/"> Petista</a>.
        Petista is an application that makes lives easier for mobile pet groomers. It allows online booking for customers via 
          <a href="https://pawgo.co/"> pawgo.co</a>.
      </p>
      <p>
